...
import { Heart } from "lucide-react"; // icon trái tim

// Ảnh
import hero from "../../assets/imgbn.png";
import big1 from "../../assets/imgb1.png"; // 570x760px
import big2 from "../../assets/imgb2.png"; // 570x760px
import small1 from "../../assets/img1.png"; // 330x400px
          ...
          {products
            ...
            .map((item) => (
              <div key={item.id}>
                ...
                {/* Thông tin sản phẩm + tim cùng hàng */}
...
<section className="mt-[210px] max-w-[1410px] mx-auto px-4 sm:px-6 lg:px-8">
  ...
  <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-10">
    {[small1, small2, small3, small1].map((src, i) => {
      const id = 200 + i; // id riêng cho block này
      return (
        <div key={id}>
          <div className="relative w-full aspect-[330/400] overflow-hidden bg-gray-50">
...
<section className="mt-[100px]">
  ...
  {/* Grid 8 ảnh nhỏ – cách tiêu đề 60px */}
